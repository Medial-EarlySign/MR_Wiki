...
* **AlgoMarker Format ETL:** Converts data from the AlgoMarker Request format into the MedRepository format for faster and more comprehensive data access. This script utilizes the `medpython-etl` infrastructure and serves as an excellent reference example: [algomarker_to_medrepository.py](https://github.com/Medial-EarlySign/MR_Tools/blob/main/test_algomarker/algomarker_to_medrepository.py)
