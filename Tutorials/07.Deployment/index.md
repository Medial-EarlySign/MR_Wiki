...
The deployment is through wrapping the model file by AlgoMarker.
...
- For your own model, you’ll need to create a configuration file.  
  See: [Setup a new AlgoMarker](../../Infrastructure%20Library/AlgoMarkers/Setup%20a%20new%20AlgoMarker.md)
...
More details can be found [here](../../Infrastructure%20Library/Medial%20Tools/Python/Python%20AlgoMarker%20API%20Wrapper.md)
