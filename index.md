...
5. Run our tools - python or [Flow](Medial%20Tools/Guide%20for%20common%20actions#2-train-a-model-from-json), [Optimizer](Medial%20Tools/Optimizer.md) to train the model, or [python code](Python/Medial's%20C++%20API%20in%20Python/Examples.md#learn-model-from-json-to-generate-matrix)
