...
* You want to use an existing model
    - The model is deployed already? - [How To Use Deployed AlgoMarker](Infrastructure%20C%20Library/AlgoMarkers/Howto%20Use%20AlgoMarker.md#how-to-use-the-deployed-algomarker)
    - The model is available, but you need to deploy it first. Please refer to [AlgoMarker Deployment](Infrastructure%20C%20Library/AlgoMarkers/Howto%20Use%20AlgoMarker.md#how-to-deploy-algomarker)
...
2. Create a data repository with your EMR data: Follow the [ETL guide](Repositories/Load%20new%20repository.md)
...
4. Specify the model architecture in JSON. Refer to: [Model Json Format](Infrastructure%20C%20Library/MedModel%20json%20format.md), [infrastucture explanation](Infrastructure%20C%20Library/index.md) 
