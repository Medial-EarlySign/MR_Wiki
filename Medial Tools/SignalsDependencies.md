# SignalsDependencies
The Code exists in: **$MR_ROOT/Tools/SignalsDependencies **and is basically using library functions in [MedRegistry ](/Infrastructure%20Home%20Page/MedProcessTools%20Library/MedRegistry)object - method called "calc_signal_stats" after loading the registry.
...
 
Explain on labeling_params and inc_labeling_params can be given in [TimeWindowInteraction](/Infrastructure%20Home%20Page/MedProcessTools%20Library/MedRegistry/TimeWindowInteraction.html). Those arguments are LabelParams objet that defines how to label sampels.
 
