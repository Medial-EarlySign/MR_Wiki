...
1. [C++ Native Wrapper](C++%20Native%20Wrapper.md): Minimal dependencies, very fast and efficient. Uses Boost Beast. Can be installed in a minimal `chainguard/glibc-dynamic` image or Ubuntu Chiselled Docker image (distroless container). 
